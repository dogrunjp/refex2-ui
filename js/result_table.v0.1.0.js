// result_table.js v0.1.0 201909025
...
(function(){
    ...
    // チャートの状態
    var sorted = false, grouped = false, ppty="value", popover = false;
    // チャート描画のためのパラメータ
    ...
    function learn_more(gid) {
        ...
        // 追加するgidが配列に含まれていない状態でs_r_infsに追加
