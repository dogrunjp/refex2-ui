<form-control>
    <nav class="navbar navbar-default">
        <div id="search" class="container-fluid">
            <div class="logotype">
                <a href="sample_2017.html"><img src="images/refex-logotype-b.png" width="108" height="141" alt="refex b logo type"></a>
            </div>
            ...
            <div class="form-controll">
                ...
                <ul class="nav navbar-right">
                    <div class="radio">
                        <label class="radio"><input type="radio" name="orgs" value="human" checked> Human</label>
                    </div>
                    <div class="radio">
                        <label class="radio"><input type="radio" name="orgs" value="mouse"> Mouse</label>
                    </div>
                </ul>
            </div>
            </div>
    ...
    // bbchartを描画するsvgの設定。mount後に設定が必要
    ...
    */
    ...
    function show_chart_view() {
        svg_bbchart.transition().duration(100).attr('height', bcnf.height + bcnf.b + bcnf.t + ccnf.h + ccnf.b);
        svg_bbchart.append("html").text("test");
    }
    ...
    // svgの定義
    var svg_bbchart = d3.select('#barchart .chart').append('svg').attr('class', 'bar_chart')
    .attr('width', bcnf.width).attr('height', (bcnf.hide));

    var focus = svg_bbchart.append('g').attr('class', 'focus').attr('transform', 'translate(' + bcnf.l + ',' + bcnf.t + ')');
    var context = svg_bbchart.append('g').attr('class', 'context').attr('transform', 'translate(' + bcnf.l + ',' + ( +bcnf.height + +bcnf.t + ccnf.t) + ')');

    var legend_view = svg_bbchart.append('g').attr('class', 'legend_view').attr('transform', 'translate(30, 200)');
    var ctrl_view = svg_bbchart.append('g').attr('class', 'contrl_view').attr('transform', 'translate(' + (bcnf.width - 50) + ',' + (bcnf.height + ccnf.h + 50) + ' )');
